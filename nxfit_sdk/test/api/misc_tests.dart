...
void miscTests() {
  group('OffsetDateTime', () {
    test("Test OffsetDateTime converter", () {
      ...
      var offsetDateTime = const OffsetDateTimeJsonConverter().fromJson(datestamp);
...
//    print(offsetDateTime.toString());
      ...
      expect(offsetHour, offsetDateTime.offset
          .toDuration()
          .inHours);
      expect(offsetHour * 60 + offsetMinute, offsetDateTime.offset
          .toDuration()
          .inMinutes);
