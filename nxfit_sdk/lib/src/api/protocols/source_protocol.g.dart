...
class _SourceProtocol implements SourceProtocol {
  ...
  Future<HttpResponse<GetSourceResponseDto>> getSource(
    ...
    final _options = _setStreamType<HttpResponse<GetSourceResponseDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<ListSourcesResponseDto>> listSources(
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<ListSourcesResponseDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<void>> updateSourcesPriorities(
      List<UpdateSourcePriorityRequestDto> priorities) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'content-type': 'application/json; charset=UTF-8'
