...
class _SessionProtocol implements SessionProtocol {
  ...
  Future<HttpResponse<CreateSessionResponseDto>> post(
    ...
    final _options =
        _setStreamType<HttpResponse<CreateSessionResponseDto>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<GetUserSessionResponseDto>> get(
    ...
    final _options =
        _setStreamType<HttpResponse<GetUserSessionResponseDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<GetUserSessionsResponseDto>> listForUser(
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<GetUserSessionsResponseDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<GetSessionsResponseDto>> list({
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<GetSessionsResponseDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
