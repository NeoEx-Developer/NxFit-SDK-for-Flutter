  ...
  Future<T> apiCall<T>(Future<T> Function() callAction) async {
    try {
      ...
      if (e.type == DioExceptionType.badResponse) {
        ...
        if (statusCode >= 400) logger.info("DIO Exception Handled [${e.type}]");

        switch (statusCode) {
          case 304:
            throw NotModifiedException(message: message, method: method, url: url, cause: e);
          case 400:
            throw BadRequestException(message: message, method: method, url: url, cause: e);
          case 401:
            throw UnauthorizedException(message: message, method: method, url: url, cause: e);
          case 403:
            throw ForbiddenException(message: message, method: method, url: url, cause: e);
          case 409:
            throw ConflictException(message: message, method: method, url: url, cause: e);
          case 501:
            throw NotImplementedException(message: message, method: method, url: url, cause: e);
          case 502:
            throw BadGatewayException(message: message, method: method, url: url, cause: e);
          case 503:
            throw ServiceUnavailableException(message: message, method: method, url: url, cause: e);
          case 504:
            throw GatewayTimeoutException(message: message, method: method, url: url, cause: e);
          default:
