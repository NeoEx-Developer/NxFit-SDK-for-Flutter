...
PutSessionRequestDto _$PutSessionRequestDtoFromJson(
  ...
  startedOnLocal: const OffsetDateTimeJsonConverter().fromJson(
    json['startedOnLocal'] as String,
  ),
  endedOnLocal: const OffsetDateTimeJsonConverter().fromJson(
    json['endedOnLocal'] as String,
  ),
...
Map<String, dynamic> _$PutSessionRequestDtoToJson(
  ...
  'startedOnLocal': const OffsetDateTimeJsonConverter().toJson(
    instance.startedOnLocal,
  ),
  'endedOnLocal': const OffsetDateTimeJsonConverter().toJson(
    instance.endedOnLocal,
  ),
  'completedOn': _$JsonConverterToJson<String, OffsetDateTime>(
    instance.completedOn,
    const OffsetDateTimeJsonConverter().toJson,
  ),
